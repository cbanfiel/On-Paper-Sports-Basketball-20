...
<View style={{flexDirection:'row', justifyContent:'center', alignItems:'center'}}>
                        ...
                        <Button titleStyle={{ fontFamily: 'advent-pro', color:'black' }} buttonStyle={{ backgroundColor: 'rgba(0,0,0,0)', borderWidth: 1, borderRadius: 25, marginTop:15, borderColor:'black' }} title="Create Team" onPress={() => { this.saveChanges() }}></Button>
