...
import { TouchableOpacity, Text, ScrollView, View, Clipboard, Alert } from 'react-native';
...
export default class RosterMenu extends React.Component {
  ...
  fantasyDraft = () => {
    Alert.alert(
      'Would you like to start a fantasy draft?',
      'The current roster will be autosaved as "FantasyDraftBackup.roster"',
      [
        {
          text: 'Cancel',
          onPress: () => { return },
        ...
        },
        {
          text: 'Start',
          onPress: () => {
            saveData('FantasyDraftBackup');
            shuffle(teams);
            Actions.fantasydraft({ update: this.updateState });
          },
        },
      ],
      { cancelable: true },
    ...
    return (
      <Background>
        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 20 }}>
              ...
              <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                <View style={{ flexDirection: 'column', alignItems: "flex-start" }}>
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <Text style={{ textAlign: "center", fontSize: 15, color: 'black', fontFamily: 'advent-pro' }}>{'PG #' + selectedTeam.firstTeam[0].number + ' ' + selectedTeam.firstTeam[0].name + ' OVR: ' + selectedTeam.firstTeam[0].rating}</Text>
                  </View>
                  <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    <CachedImage style={{ overflow: 'hidden', resizeMode: 'contain', height: 50, width: 50, margin: 5, }} uri={selectedTeam.firstTeam[1].faceSrc} />
                    <Text style={{ textAlign: "center", fontSize: 15, color: 'black', fontFamily: 'advent-pro' }}>{'SG #' + selectedTeam.firstTeam[1].number + ' ' + selectedTeam.firstTeam[1].name + ' OVR: ' + selectedTeam.firstTeam[1].rating}</Text>
                  </View>
                  <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    <CachedImage style={{ overflow: 'hidden', resizeMode: 'contain', height: 50, width: 50, margin: 5, }} uri={selectedTeam.firstTeam[2].faceSrc} />
                    <Text style={{ textAlign: "center", fontSize: 15, color: 'black', fontFamily: 'advent-pro' }}>{'SF #' + selectedTeam.firstTeam[2].number + ' ' + selectedTeam.firstTeam[2].name + ' OVR: ' + selectedTeam.firstTeam[2].rating}</Text>
                  </View>
                  <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    <CachedImage style={{ overflow: 'hidden', resizeMode: 'contain', height: 50, width: 50, margin: 5, }} uri={selectedTeam.firstTeam[3].faceSrc} />
                    <Text style={{ textAlign: "center", fontSize: 15, color: 'black', fontFamily: 'advent-pro' }}>{'PF #' + selectedTeam.firstTeam[3].number + ' ' + selectedTeam.firstTeam[3].name + ' OVR: ' + selectedTeam.firstTeam[3].rating}</Text>
                  </View>
                  <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    <CachedImage style={{ overflow: 'hidden', resizeMode: 'contain', height: 50, width: 50, margin: 5, }} uri={selectedTeam.firstTeam[4].faceSrc} />
                    <Text style={{ textAlign: "center", fontSize: 15, color: 'black', fontFamily: 'advent-pro' }}>{'C #' + selectedTeam.firstTeam[4].number + ' ' + selectedTeam.firstTeam[4].name + ' OVR: ' + selectedTeam.firstTeam[4].rating}</Text>
                  </View>
                </View>
              </View>
            </Card>
          ...
          {
            <TouchableOpacity style={{ width: '100%' }} onPress={() => { this.fantasyDraft() }}>
              ...
              >
                ...
                <Divider style={{ backgroundColor: 'black', height: 1, margin: 5 }} ></Divider>
                <Text style={{ textAlign: "center", fontSize: 20, color: 'black', fontFamily: 'advent-pro' }}>{'Fantasy Draft'}</Text>
              </Card>
            </TouchableOpacity>
          }
