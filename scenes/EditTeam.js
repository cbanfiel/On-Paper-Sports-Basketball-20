            ...
            <Background>
                <ScrollView contentContainerStyle={{ paddingBottom: 20 }}>
                    ...
                    <Card
                        ...
                        <Button titleStyle={{ fontFamily: 'advent-pro' , color: 'black'}} buttonStyle={{ backgroundColor: 'rgba(0,0,0,0)', borderColor: 'black', borderWidth: 1, borderRadius: 25, marginVertical:10 }} title="Generate New Roster" onPress={() => { this.generateNewRoster() }}></Button>
...
<View>
                        ...
                        <Button titleStyle={{ fontFamily: 'advent-pro' , color: 'black'}} buttonStyle={{ backgroundColor: 'rgba(0,0,0,0)', borderColor: 'black', borderWidth: 1, borderRadius: 25, marginVertical:10 }} title="Commit Changes" onPress={() => { this.saveChanges() }}></Button>

                

                        <Button titleStyle={{ fontFamily: 'advent-pro' , color: 'black'}} buttonStyle={{ backgroundColor: 'rgba(255,0,0,0.75)', borderColor: 'black', borderWidth: 1, borderRadius: 25, marginVertical:10 }} title="Delete Team" onPress={() => { this.deleteTeam() }}></Button>
