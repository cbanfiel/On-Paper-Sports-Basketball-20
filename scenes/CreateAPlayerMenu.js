...
<Text style={{ textAlign: "center", fontSize: 20, color: 'black', fontFamily: 'advent-pro' }}>{"HEIGHT: " + this.state.height}</Text>
                        ...
                        <Button titleStyle={{ fontFamily: 'advent-pro', color:'black' }} buttonStyle={{ backgroundColor: 'rgba(0,0,0,0)', borderColor: 'black', borderWidth: 1, borderRadius: 25, marginBottom:10 }} title="Select Team" onPress={() => { Actions.push('teamlist', {updateTeam : this.updateTeam, home:6}) }}></Button>
                        

                        <Button titleStyle={{ fontFamily: 'advent-pro', color:'black' }} buttonStyle={{ backgroundColor: 'rgba(0,0,0,0)', borderColor: 'black', borderWidth: 1, borderRadius: 25 }} title="Create Player" onPress={() => { this.saveChanges() }}></Button>
