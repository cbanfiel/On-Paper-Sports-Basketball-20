                ...
                <ScrollView style={{ flex: 1 }} >
                    ...
                    <TouchableOpacity style={{ width: '100%' }} onPress={() => Actions.editplayerratings({ selectedPlayer: this.state.player, updateState : this.updateState })}>
                        ...
                        <Card
                            ...
                            <Text style={{ textAlign: "center", fontSize: 20, color: 'black', fontFamily: 'advent-pro' }}>{"REB: " + this.state.player.reb}</Text>
                            <Text style={{ textAlign: "center", fontSize: 20, color: 'black', fontFamily: 'advent-pro' }}>{"3PT: " + this.state.player.threePoint}</Text>
                            <Text style={{ textAlign: "center", fontSize: 20, color: 'black', fontFamily: 'advent-pro' }}>{"FT: " + this.state.player.ft}</Text>
                        </Card>
                    </TouchableOpacity>
                        ...
                        this.props.view === 'draft' ? (
                            ...
                            <TouchableOpacity style={{ width: '100%' }} onPress={() => { Actions.playerstatshistory({ player: this.state.player }) }}>
                                ...
                                <Card
                                    ...
                                    <Divider style={{ backgroundColor: 'black', margin: 10 }}></Divider>
                                    <Text style={{ textAlign: "center", fontSize: 20, color: 'black', fontFamily: 'advent-pro' }}>{"PPG: " + (Math.round((this.state.player.seasonPoints / this.state.player.statsHistory.length) * 10) / 10)}</Text>
                                    <Text style={{ textAlign: "center", fontSize: 20, color: 'black', fontFamily: 'advent-pro' }}>{"REB: " + this.state.player.seasonRebounds}</Text>
                                    <Text style={{ textAlign: "center", fontSize: 20, color: 'black', fontFamily: 'advent-pro' }}>{"2PA: " + this.state.player.seasonTwoPointersAtt}</Text>
                                    <Text style={{ textAlign: "center", fontSize: 20, color: 'black', fontFamily: 'advent-pro' }}>{"2PM: " + this.state.player.seasonTwoPointersMade}</Text>
                                    <Text style={{ textAlign: "center", fontSize: 20, color: 'black', fontFamily: 'advent-pro' }}>{"3PA: " + this.state.player.seasonThreePointersAtt}</Text>
                                    <Text style={{ textAlign: "center", fontSize: 20, color: 'black', fontFamily: 'advent-pro' }}>{"3PM: " + this.state.player.seasonThreePointersMade}</Text>
                                </Card>
                            </TouchableOpacity>
