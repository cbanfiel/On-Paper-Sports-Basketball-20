            ...
            <Background>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                  ...
                  <CachedImage style={{ flex: 1, overflow: 'hidden', resizeMode: 'contain', height: 75, width: 75, margin: 5 }} uri={this.state.team.logoSrc } />
                    ...
                    <Text style={{ flex:1,  textAlign: "center", fontSize: 20, color: 'black', fontFamily: 'advent-pro' }}>{sortedRoster(this.state.team,'ppg')[0].statsHistory.length > 0 ? (Math.round((sortedRoster(this.state.team,'ppg')[0].seasonPoints / sortedRoster(this.state.team,'ppg')[0].statsHistory.length) * 10) / 10) + ' PPG' : null}</Text>
                </View>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                  ...
                  <CachedImage style={{ flex: 1, overflow: 'hidden', resizeMode: 'contain', height: 75, width: 75, margin: 5 }} uri={leaugeLeaders().roster[0].teamLogoSrc }/>
                    ...
                    <Text style={{ flex:1,  textAlign: "center", fontSize: 20, color: 'black', fontFamily: 'advent-pro' }}>{leaugeLeaders().roster[0].statsHistory.length > 0 ? (Math.round((leaugeLeaders().roster[0].seasonPoints / leaugeLeaders().roster[0].statsHistory.length) * 10) / 10) + ' PPG' : null}</Text>
                </View>
